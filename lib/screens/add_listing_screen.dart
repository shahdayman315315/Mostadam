...
class _AddListingScreenState extends State<AddListingScreen> {
  ...
  final TextEditingController _co2SavedController = TextEditingController();
  ...
  Future<void> _publishListing() async {
    if (_titleController.text.isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please add photos and fill required fields'),
        ),
      );
      return;
    }
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('products').add({
        ...
        'repairHistory': _recyclingBackground,
        'co2Saved': double.tryParse(_co2SavedController.text) ?? 0.0,
        'images': imageUrls,
              ...
              child: Column(
                children: [
                  ...
                  _buildSectionCard(
                    ...
                    subtitle: 'Set a fair price and show your impact.',
                    stepLabel: 'Step 3',
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // 1. Current Selling Price
                        _buildLabel('Selling Price (USD)'),
                        _buildTextField(
                          _priceController,
                          '0',
                        ...
                        // 3. Environmental Impact (New Field)
                        _buildLabel('Environmental Impact (CO2 saved in kg)'),
                        _buildTextField(
                          _co2SavedController,
                          'e.g. 15.5',
                          keyboard: TextInputType.number,
      ...
      children: [
        ...
        const Column(
          ...
          children: [
            ...
            Text('New Listing', style: TextStyle(color: Colors.grey)),
          ],
        ),
      ],
    );
            ...
            (c) => Padding(
              ...
              child: ChoiceChip(
                ...
                labelStyle: TextStyle(
                  color: _condition == c ? Colors.white : Colors.black,
                ),
      ...
      children: ['Repaired', 'Upcycled', 'Recycled']
          .map(
            (r) => ChoiceChip(
              ...
              selectedColor: color,
              labelStyle: TextStyle(
                color: _recyclingBackground == r ? Colors.white : Colors.black,
              ),
              onSelected: (s) => setState(() => _recyclingBackground = r),
            ),
          )
          .toList(),
    );
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          SizedBox(width: 10),
          Text('Standard Shipping Included', style: TextStyle(fontSize: 13)),
        ],
      ),
    );
  }
  ...
  Widget _buildToggle(
    ...
    return Row(
      ...
      children: [
        Text(title),
        Switch(value: val, activeColor: color, onChanged: onChange),
      ],
    );
  }

  Widget _buildImageBtn(IconData icon, String label, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
      child: Container(
